...
export const DAY_SIZE = (Dimensions.get('screen').width / WEEK_DAYS - (SCREEN_HORIZONTAL_PADDING + 5)) // divite o tamhanho da tela do usuário para saber o tamanho que cada elemento poderá ter
